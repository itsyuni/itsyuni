...
Я системный администратор, дизайнер и человек имеющий руки.<br>
Занимаюсь разными проектами как и для себя, так и для других.
- Работаю сисадмином в WIK Group (Wikkeo.com)
- Работаем над monodigital
...
## Проекты 🛠
- <b>monodigital</b> — Группа сервисов, скоро
